...
const Complete_project = () => {
    ...
    const mobiledrop = () => {
        if (toggledrop === false) {
            ...
            settoggledrop(true)
            setdropdown(true)
            document.querySelector('.complete-project-img').style.marginTop = '240px'
        } else {
            setAll(true);
            settoggledrop(false)
                        ...
                        <div className={dropdown ? 'project-all' : ''}>
                            ...
                            <div className={dropdown ? 'dropdown' : 'complete-project-heading'}>
                                ...
                                <div className={toggledrop ? 'catagory-programming' : 'category-drop'}>
                                    ...
                                    <button value='design' className={optionValue==='Design' ? 'active' : ''} onClick={hanldeImage}>Design</button>
